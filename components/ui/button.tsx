...
const buttonStyles = tv({
  ...
  base: [
    ...
    "*:data-[slot=icon]:-mx-0.5 hover:*:data-[slot=icon]:text-current/90 data-pressed:*:data-[slot=icon]:text-current *:data-[slot=icon]:my-1 *:data-[slot=icon]:size-4 *:data-[slot=icon]:shrink-0 *:data-[slot=icon]:text-current/60 *:data-[slot=icon]:transition",
  ...
  variants: {
    intent: {
      primary: [
        ...
        "inset-shadow-primary-fg/20 hover:inset-shadow-primary-fg/25 data-pressed:inset-shadow-primary-fg/20",
      ],
      secondary: [
        ...
        "inset-shadow-white/15 hover:inset-shadow-white/20 data-pressed:inset-shadow-white/15",
      ],
      warning: [
        ...
        "inset-shadow-white/25 hover:inset-shadow-white/30 data-pressed:inset-shadow-white/25",
      ],
      danger: [
        ...
        "inset-shadow-danger-fg/30 hover:inset-shadow-danger-fg/35 data-pressed:inset-shadow-danger-fg/30",
      ],
      outline: [
        "inset-ring-0 inset-shadow-none [--btn-border:var(--color-border)] hover:bg-secondary data-pressed:bg-secondary",
      ],
      plain:
        "inset-ring-0 inset-shadow-none [--btn-border:transparent] hover:bg-secondary data-pressed:bg-secondary",
    },
    size: {
      "extra-small":
