            ...
            <CalendarCell
              ...
              className={composeRenderProps(className, (className, { isSelected, isDisabled }) =>
                cn(
                  ...
                  isSelected &&
                    "bg-primary text-primary-fg hover:bg-primary/90 data-invalid:bg-danger data-pressed:bg-primary data-invalid:text-danger-fg forced-colors:bg-[Highlight] forced-colors:text-[Highlight] forced-colors:data-invalid:bg-[Mark]",
