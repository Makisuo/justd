...
const table = tv({
  slots: {
    ...
    header: "x32 border-b",
    row: "tr group relative cursor-default border-b bg-bg text-muted-fg outline-hidden ring-primary data-selected:hover:bg-(--table-selected-bg)/70 data-selected:bg-(--table-selected-bg) data-focus-visible:ring-1 data-focused:ring-0 dark:data-selected:hover:bg-[color-mix(in_oklab,var(--color-primary)_30%,black_70%)]",
    cellIcon:
