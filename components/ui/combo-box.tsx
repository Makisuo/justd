...
const comboboxStyles = tv({
  slots: {
    ...
    chevronButton:
      "h-7 w-8 rounded outline-offset-0 active:bg-transparent hover:bg-transparent data-pressed:bg-transparent **:data-[slot=icon]:data-pressed:text-fg **:data-[slot=icon]:text-muted-fg **:data-[slot=icon]:hover:text-fg",
