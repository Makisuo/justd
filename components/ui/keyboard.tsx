...
const keyboardStyles = tv({
  slots: {
    base: "hidden text-current/70 group-data-focused:text-fg group-hover:text-fg group-disabled:opacity-50 group-data-focused:opacity-90 lg:inline-flex forced-colors:group-data-focused:text-[HighlightText]",
