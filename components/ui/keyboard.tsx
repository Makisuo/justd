...
const keyboardStyles = tv({
  slots: {
    base: "hidden text-current/70 group-hover:text-fg group-disabled:opacity-50 group-focus:text-fg group-focus:opacity-90 lg:inline-flex forced-colors:group-focus:text-[HighlightText]",
