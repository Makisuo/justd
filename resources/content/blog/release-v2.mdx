---
title: Release 2.0.0
description: The second release of Justd. It includes all the components and utilities that you need to build your next project.
...
* chore(deps): upgrade @intentui/icons to v1.10.0 by @phucto2001 in https://github.com/irsyadadl/justd/pull/248
* chore(deps): upgrade @intentui/icons to v1.10.0 by @irsyadadl in https://github.com/irsyadadl/justd/pull/252
