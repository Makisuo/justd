...
## Blocks
Want to move fast without spending hours building components? No problem! **[Intent Blocks](https://blocks.getjustd.com)** offers a collection of ready-to-use components, covering everything from **Application** and **Marketing** to **Charts** and **Commerce**. Easily customize them to fit your needs and build faster than ever.
